...
Generate boilerplate code for R6 classes. Given R6 class create getters and/or setters for selected class fields. 
...
Given an example R6 class we can easily create methods to put into class definition.
...
Two addins are also supplied:
  ...
  - Generate R6 methods gadget: gives you control over which methods are generated
